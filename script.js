...
const addInpFunc = (section, isSet = false,labelText = "", pHolder1="food",pHolder2="Calories", type = "text") => {
...
//The arr para is the array that will receive the values
const addArrInfoFunc = (arr, exerciseCalories,food, foodCalories) =>
    arr.push({
    id: arr.length,
    date: new Date(),
    exerciseCalories,
...
const toggleMyClassFunc =(myClass,el1,el2=null)=>{
